...
function inflateOrderMenu(data) {
    ...
    for (var i=0; i<data['Bases'].length; i++){
        if (data['Bases'][i]['available'] === '1')
            $('#basesDiv ul:last-child').append("<li> <input type=\"radio\" name=\"baseType\" id=\"" + data['Bases'][i]['name'] + "\" value=\"" + data['Bases'][i]['name'] + "\" required> <label for=\"" + data['Bases'][i]['name'] + "\">" + data['Bases'][i]['name'] + "</label></li>");
    }
    ...
    for (var i=0; i<data['Breads'].length; i++){
        if (data['Breads'][i]['available'] === '1')
            $('#breadsDiv ul:last-child').append("<li> <input type=\"radio\" name=\"breadType\" id=\"" + data['Breads'][i]['name'] + "\" value=\"" + data['Breads'][i]['name'] + "\" required> <label for=\"" + data['Breads'][i]['name'] + "\">" + data['Breads'][i]['name'] + "</label></li>");
    }
    ...
    for (var i=0; i<data['Cheeses'].length; i++){
        if (data['Cheeses'][i]['available'] === '1')
            $('#cheesesDiv ul:last-child').append("<li> <input type=\"radio\" name=\"cheeseType\" id=\"" + data['Cheeses'][i]['name'] + "\" value=\"" + data['Cheeses'][i]['name'] + "\" required> <label for=\"" + data['Cheeses'][i]['name'] + "\">" + data['Cheeses'][i]['name'] + "</label></li>");
    }
    ...
    for (var i=0; i<data['Toppings'].length; i++){
        if (data['Toppings'][i]['available'] === '1')
            $('#toppingsDiv ul:last-child').append("<li> <input type=\"checkbox\" name=\"toppingType[]\" id=\"" + data['Toppings'][i]['name'] + "\" value=\"" + data['Toppings'][i]['name'] + "\"> <label for=\"" + data['Toppings'][i]['name'] + "\">" + data['Toppings'][i]['name'] + "</label></li>");
    }
    ...
    for (var i=0; i<data['Fries'].length; i++){
        if (data['Fries'][i]['available'] === '1')
            $('#friesDiv ul:last-child').append("<li> <input type=\"radio\" name=\"friesType\" id=\"" + data['Fries'][i]['name'] + "\" value=\"" + data['Fries'][i]['name'] + "\" required> <label for=\"" + data['Fries'][i]['name'] + "\">" + data['Fries'][i]['name'] + "</label></li>");
    }

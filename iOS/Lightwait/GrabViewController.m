...
- (void)viewDidLoad
{
    ...
    wrapsArray = [[NSArray alloc] initWithObjects:@"Barbecue Chicken", @"Buffalo Chicken", @"Turkey Wrap", @"Photo Gallery", @"The Court at Twelve Oaks", @"Video", @"Contact Us", @"About", nil];
